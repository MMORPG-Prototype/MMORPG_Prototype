...
public class NpcDialogStartPacketHandler extends PacketHandlerBase<NpcDialogStartPacket>
{
	...
	@Override
	public void handle(Connection connection, NpcDialogStartPacket packet)
	{
