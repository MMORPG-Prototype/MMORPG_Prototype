...
public abstract class ThrowableNonSplashAttackSpell extends ThrowableObject
{
    ...
    public ThrowableNonSplashAttackSpell(Spell spell, Texture lookout, long id, Monster source, GameObjectsContainer linkedContainer, PacketsSender packetsSender)
    {
