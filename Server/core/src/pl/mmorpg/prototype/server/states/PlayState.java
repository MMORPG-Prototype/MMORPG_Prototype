...
public class PlayState extends State implements GameObjectsContainer, PacketsSender, EventHandler
{
    ...
    private void addSpawner(RectangleMapObject spawnerElement)
    {
        ...
        Class<? extends Monster> monsterType = (Class<? extends Monster>) GameObjectsIdentifier
    ...
    {
        GameObject gameObject = objectsFactory.produce(GameObjectsIdentifier.getObjectType(identifier),
                IdSupplier.getId());
